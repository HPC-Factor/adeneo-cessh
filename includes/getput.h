...
#define PUT_64BIT(cp, value) do { \
  (cp)[0] = (u_char) ((value) >> 56); \
  (cp)[1] = (u_char) ((value) >> 48); \
  (cp)[2] = (u_char) ((value) >> 40); \
  (cp)[3] = (u_char) ((value) >> 32); \
  (cp)[4] = (u_char) ((value) >> 24); \
  (cp)[5] = (u_char) ((value) >> 16); \
  (cp)[6] = (u_char) ((value) >> 8); \
  (cp)[7] = (u_char) ((value)); } while (0)

#define PUT_32BIT(cp, value) do { \
  (cp)[0] = (u_char) ((value) >> 24); \
  (cp)[1] = (u_char) ((value) >> 16); \
  (cp)[2] = (u_char) ((value) >> 8); \
  (cp)[3] = (u_char) ((value)); } while (0)

#define PUT_16BIT(cp, value) do { \
  (cp)[0] = (u_char) ((value) >> 8); \
  (cp)[1] = (u_char) ((value) & 0xFF); } while (0)
